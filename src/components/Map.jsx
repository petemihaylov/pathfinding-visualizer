...
import { createGeoJSONCircle } from '../app/helpers';
...
import { INITIAL_COLORS, INITIAL_VIEW_STATE } from '../app/config';
import useSmoothStateChange from '../hooks/useSmoothStateChange';
import { MapConfig } from '../app/map';
function Map() {
  ...
  async function mapClick(e, info, radius = 6) {
      ...
      >
        ...
        >
          <PolygonLayer
            ...
            getFillColor={[80, 210, 0, 40]}
            getLineColor={[9, 142, 46, 75]}
            getLineWidth={3}

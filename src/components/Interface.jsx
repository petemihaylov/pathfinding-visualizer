...
import { PlayArrow, Pause, Replay } from '@mui/icons-material'; // Settings, Movie,
...
import { INITIAL_COLORS, LOCATIONS } from '../app/config';
import { arrayToRgb, rgbToArray } from '../app/helpers';
        ...
        >
          <div className="sidebar-container">
            ...
            <div className="styles-container">
                ...
                <div className="color-container">
                  ...
                  <IconButton
                    onClick={() => {
                      setColors({
                        ...colors,
                        startNodeFill: INITIAL_COLORS.startNodeFill,
                      });
                    }}
                ...
                <div className="color-container">
                  ...
                  <IconButton
                    onClick={() => {
                      setColors({
                        ...colors,
                        startNodeBorder: INITIAL_COLORS.startNodeBorder,
                      });
                    }}
                    style={{ backgroundColor: 'transparent' }}
                    size="small"
              ...
              <div>
                <Typography id="end-fill-label">End node fill color</Typography>
                <div className="color-container">
                  <MuiColorInput
                  ...
                  <IconButton
                    onClick={() => {
                      setColors({
                        ...colors,
                        endNodeFill: INITIAL_COLORS.endNodeFill,
                      });
                    }}
                    style={{ backgroundColor: 'transparent' }}
                    size="small"
                ...
                <div className="color-container">
                  ...
                  <IconButton
                    onClick={() => {
                      setColors({
                        ...colors,
                        endNodeBorder: INITIAL_COLORS.endNodeBorder,
                      });
                    }}
                    style={{ backgroundColor: 'transparent' }}
                    size="small"
              ...
              <div>
                <Typography id="path-label">Path color</Typography>
                <div className="color-container">
                  <MuiColorInput
              ...
              <div>
                <Typography id="route-label">Shortest route color</Typography>
                <div className="color-container">
                  <MuiColorInput
